...
#
# Examples:
#   Node 22 (default): --build-arg NODEJS_VERSION=22 --build-arg NODEJS_IMAGE_TAG=9.7-1776041578
#   Node 24: --build-arg NODEJS_VERSION=24 --build-arg NODEJS_IMAGE_TAG=<appropriate-tag>
#
# To find available tags, visit:
# https://catalog.redhat.com/software/containers/ubi9/nodejs-22/62e8e7ed22d1d3c2dfe2ca01
ARG NODEJS_VERSION=22
ARG NODEJS_IMAGE_TAG=9.7-1776041578
FROM registry.access.redhat.com/ubi9/nodejs-${NODEJS_VERSION}:${NODEJS_IMAGE_TAG} as builder
